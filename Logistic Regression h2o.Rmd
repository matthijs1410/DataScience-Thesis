...
# Extract SHAP values
shap_values <- h2o.predict_contributions(default_lgr, tst_usfs_h2o)
...
shap_viz <- shapviz(shap_values_df, X = tst_usfs, type = "contributions")

# Plot SHAP summary
plot_summary(shap_viz, top_n = 10)  # You can adjust top_n as needed
